# ---------------------------------------------------------------
# Full-memory cycle DAFormer: stronger target consistency.
# ---------------------------------------------------------------
...
uda = dict(
    ...
    lambda_target_consistency=0.5,
    target_consistency_threshold=0.8,
...
name = 'gta2cs_uda_cycle_dacs_daformer_mitb5_s0_ablation_levels23_tc05_thr08'
name_uda = 'cycle_dacs_a999_fd_things_levels23_lcf1_lsc025_ltc05_thr08_guard'
