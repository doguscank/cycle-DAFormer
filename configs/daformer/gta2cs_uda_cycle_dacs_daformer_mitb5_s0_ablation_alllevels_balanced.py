# ---------------------------------------------------------------
# Full-memory cycle DAFormer: all cycle levels, balanced losses.
# ---------------------------------------------------------------
...
name = 'gta2cs_uda_cycle_dacs_daformer_mitb5_s0_ablation_alllevels_balanced'
name_uda = 'cycle_dacs_a999_fd_things_alllevels_lcf1_lsc025_ltc025_guard'
