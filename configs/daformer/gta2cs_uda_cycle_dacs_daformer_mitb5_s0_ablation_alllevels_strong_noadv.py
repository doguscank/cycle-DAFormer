# ---------------------------------------------------------------
# Full-memory cycle DAFormer: all cycle levels, strong losses, no adv.
# ---------------------------------------------------------------
...
name = 'gta2cs_uda_cycle_dacs_daformer_mitb5_s0_ablation_alllevels_strong_noadv'
name_uda = 'cycle_dacs_a999_fd_things_alllevels_lcf3_lsc015_ltc1_guard'
